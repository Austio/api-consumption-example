...
This is a standard rails app using rails 4 that demonstrates how to setup a skelton application to consume an API and keep subscriptions betweent he two.
